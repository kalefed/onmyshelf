...
export default async function Home({ searchParams }) {
  ...
  return (
    <main className="mt-10">
      ...
      {/* Dashboard */}
      <section className="grid grid-cols-4 gap-4 grid-rows-5 mt-10 mx-4">
        ...
        {/* Currently Reading */}
        <section className="bg-white rounded-xl row-span-2 row-start-2 col-start-1 p-4">
          <h3 className="text-lg font-semibold mb-4">Currently Reading</h3>
          <CurrentlyReading />
        </section>

        {/* Up Next */}
        <section className="bg-white rounded-xl row-span-2 row-start-2 col-start-2 p-4">
          <h3 className="text-lg font-semibold mb-4">Up Next</h3>
          <UpNext />
        </section>

        {/* Reading Stats Overview */}
        <section className="bg-white rounded-xl col-span-2 row-span-4 row-start-2 col-start-3 p-4">
          <h3 className="text-lg font-semibold mb-4">Reading Stats</h3>
        </section>

        {/* Want to Read */}
        <section className="bg-white rounded-xl col-span-2 row-span-2 col-start-1 row-start-4 p-4">
